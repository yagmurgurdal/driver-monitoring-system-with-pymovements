...
def main():
    parser = argparse.ArgumentParser(description="Compare multiple models on the baseline feature set.")
    parser.add_argument(
        "--window-root",
    ...
    parser.add_argument(
        "--output-dir",
        default=str(PROJECT_ROOT / "results" / "model_comparison_baseline"),
