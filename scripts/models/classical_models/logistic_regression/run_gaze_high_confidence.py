...
if __name__ == "__main__":
    run_named_model_cli(
        description="Run the Logistic Regression gaze high-confidence experiment.",
        model_key="logistic_regression",
        feature_set="gaze",
        use_high_confidence=True,
        default_window_root=str(PROJECT_ROOT / "window_dataset_with_gaze"),
        default_output_dir=str(PROJECT_ROOT / "results" / "logistic_regression_gaze_high_confidence"),
    )
