...
def main():
    parser = argparse.ArgumentParser(description="Train the gaze-supported high-confidence Random Forest model.")
    parser.add_argument(
        "--window-root",
    ...
    parser.add_argument(
        "--output-dir",
        default=str(PROJECT_ROOT / "results" / "random_forest_gaze_high_confidence"),
